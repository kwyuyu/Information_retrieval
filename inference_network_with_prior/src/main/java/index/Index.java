...
public interface Index {
	...
	/**
	 * @return the scene string for the given docID
	 */
	...
	/**
	 * NB: this gets refactored out when doing InferenceNetworkQuery query retrieval
	...
	/**
	 * @return get prior probability with given name and docId
	 * @param name uniform or random.
